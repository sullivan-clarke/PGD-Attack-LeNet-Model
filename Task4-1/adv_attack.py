...
# PGD Attack, function used for attack itself
...
if __name__ == "__main__":
    ...
    with open("CSVs/Adam.csv", 'w') as f:
        pass
    with open("CSVs/Adam.csv", 'a') as f:
        f.write("NumIterations,Accuracy\n")
    
    #Runs the PGD attack for 10 trials
    for i in range(10):
        adv_correct = 0  #Rests variables with every run
        total       = 0
        processed = 0
        print(f"\nTRIAL {i}:")
        ...
        with open("CSVs/Adam.csv", 'a') as f:  #Writes to csv file
            f.write(f"{i+1},{adv_acc}\n")
        
        #Prints out accuracy information to terminal 
